...
/* کارت هر گروه */
.dash-box-chats .dash-card { background: #fafbfc; border-radius: 0.875rem; padding: 0; margin: 0 0.5rem 0.6rem; box-shadow: 0 1px 6px rgba(0,0,0,.2); border: 1px solid #e5e7eb; overflow: hidden; }
.here-column-1{
...
/* هر پیام */
.dash-box-chats .dash-msg-item { padding: 3px 5px; border-bottom: 1px solid #f1f5f9; font-size: 12px; background: #fff; transition: background 0.15s; }
...
.dash-box-chats .dash-code-line { font-weight: 600; color: #334155; cursor: pointer; padding: 0; }
...
/* ردیف دکمه‌های کد */
.dash-box-chats .dash-code-btns { display: flex; flex-wrap: wrap; gap: 0.35rem; margin-top: 0.1rem; align-items: center; }
.dash-box-chats .dash-btn-code { padding: 3px 0!important; border-radius: 0.5rem; font-size: 11px; font-weight: 600; transition: all 0.15s; min-width: 28px; text-align: center; }
...
.dash-box-chats .dash-comment-input { width: 100%; max-width: 140px; height: 20px; padding: 0 0.5rem; font-size: 11px; border-radius: 0.4rem; background: #f8fafc; box-shadow: 0 0 0 1px #e2e8f0; box-sizing: border-box; }
.dash-box-chats .dash-comment-input:focus { outline: none; box-shadow: 0 0 0 2px #3b82f6; }
.dash-box-chats .dash-input-wrap { display: flex; flex: 1; min-width: 0; height: 20px; background: #f1f5f9; border-radius: 0.4rem; overflow: hidden; box-shadow: 0 0 0 1px #e2e8f0; }
.dash-box-chats .dash-input-wrap input { font-size: 11px; flex: 1; min-width: 0; background: transparent; height: 100%; }
...
<div class="dash-box-chats float-left m-2 w-[26%] max-h overflow-auto here-column-1">
            ...
            <div class="dash-card">
                ...
                @foreach($messages as $message)
                        ...
                        <li id="message-{{ $message->id }}" class="dash-msg-item">
                            ...
                            <p onclick="copyText(this)" class="chat-code chat-group-{{ $groupId }} dash-code-line inline-block">{{ trim(explode(':', $message->code)[0]) }}</p>
