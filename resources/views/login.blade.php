...
<body class="auth-page flex items-center justify-center p-4">
    <div class="w-full max-w-[420px] auth-card">
        <div class="bg-white rounded-3xl shadow-2xl shadow-black/25 p-8 sm:p-10">
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-bold text-slate-800">ورود به حساب</h1>
                <p class="text-slate-500 mt-2 text-sm">ایمیل و رمز عبور خود را وارد کنید</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <button type="submit"
                        class="auth-btn w-full py-4 rounded-xl font-semibold text-white">
                    ورود
                </button>
            </form>
            ...
            <p class="mt-7 text-center text-slate-500 text-sm">
                حساب کاربری ندارید؟
                <a href="{{ route('register') }}" class="auth-link font-medium text-slate-700">ثبت‌نام</a>
            </p>
        </div>
    </div>
</body>
